...
The project is under active development. The stack is Rust + Tauri for the desktop/backend layer and Svelte + TypeScript + Vite for the frontend.

## Contributing

Never commit credentials or local `.env` files. Keep changes focused and include tests for backend behavior.
